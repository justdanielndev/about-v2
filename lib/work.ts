...
<img src="/shadowborne-aria-design.webp" alt="Aria" class="project-banner" loading="lazy" />
...
<img src="/shadowborne-aria-concept.webp" alt="${getImageCaption("/shadowborne-aria-concept.webp")}" class="project-banner" loading="lazy" />
...
<img src="/shadowborne-aria-haircolor.webp" alt="${getImageCaption("/shadowborne-aria-haircolor.webp")}" class="project-banner" loading="lazy" />
...
<img src="/shadowborne-umbriel-design.webp" alt="Umbriel" class="project-banner" loading="lazy" />
...
<img src="/shadowborne-umbriel-evolution.webp" alt="${getImageCaption("/shadowborne-umbriel-evolution.webp")}" class="project-banner" loading="lazy" />
...
<img src="/shadowborne-zarka-design.webp" alt="Zarka" class="project-banner" loading="lazy" />
...
<img src="/shadowborne-zarka-evolution.webp" alt="${getImageCaption("/shadowborne-zarka-evolution.webp")}" class="project-banner" loading="lazy" />
