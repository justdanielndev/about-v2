...
export const works: ProjectEntry[] = [
  {
    ...
    image: "/shadowborne-chronicles-characters-thumbnail.png",
    content: `
<img src="/shadowborne-chronicles-character-sheets.png" alt="Shadowborne Chronicles character sheets" class="project-banner" />
...
<img src="/shadowborne-aria-design.png" alt="Aria" class="project-banner" />
...
<img src="/shadowborne-aria-concept.png" alt="${getImageCaption("/shadowborne-aria-concept.png")}" class="project-banner" />
...
<img src="/shadowborne-aria-haircolor.png" alt="${getImageCaption("/shadowborne-aria-haircolor.png")}" class="project-banner" />
...
<img src="/shadowborne-umbriel-design.png" alt="Umbriel" class="project-banner" />
...
<img src="/shadowborne-umbriel-evolution.png" alt="${getImageCaption("/shadowborne-umbriel-evolution.png")}" class="project-banner" />
...
<img src="/shadowborne-zarka-design.png" alt="Zarka" class="project-banner" />
...
<img src="/shadowborne-zarka-evolution.png" alt="${getImageCaption("/shadowborne-zarka-evolution.png")}" class="project-banner" />
